...
3. Open OpenSearch Dashboards at <http://localhost:5601> and sign in with **admin** / **admin** (after `securityadmin`; при другом способе инициализации security смотрите пароль в `internal_users.yml` или demo config).